...
const DashboardSidebar = () => {
  ...
  const sidebarContent = (
    <aside aria-label="Main navigation" className="w-56 h-dvh h-[100dvh] bg-sidebar border-r border-sidebar-border flex flex-col shrink-0 safe-area-left safe-area-top safe-area-bottom">
