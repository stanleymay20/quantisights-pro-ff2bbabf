...
const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: Eye, label: "Misses Review", path: "/misses" },
    ],
  },
  {
    label: "Data",
    icon: Database,
    items: [
      { icon: Cable, label: "Connectors", path: "/data-connectors" },
      { icon: Upload, label: "Upload CSV", path: "/data-upload" },
      { icon: Database, label: "Catalog", path: "/data-catalog" },
      { icon: Search, label: "Explorer", path: "/dataset-explorer" },
      { icon: Database, label: "Sources", path: "/data-sources" },
