...
const LAYERS = [
  ...
  },
  {
    ...
    description: "After pilot success, convert into recurring platform access. Priced by tier — Starter, Growth, or Enterprise.",
    deliverables: [
      "Full workspace & project management",
      "Unlimited data pipelines & integrations",
      "AI intelligence modules (advisory, forecasting, simulations)",
