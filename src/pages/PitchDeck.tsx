...
const SLIDES: Slide[] = [
  {
    ...
    content: (
      <div className="text-center">
        ...
        <p className="text-primary font-semibold text-lg mb-4">AI-Powered Decision Governance Infrastructure</p>
    ...
    content: (
      <div className="space-y-4">
        ...
        <div className="space-y-2 text-xs text-muted-foreground">
          ...
          <div className="flex items-start gap-2"><CheckCircle2 className="w-3.5 h-3.5 text-primary shrink-0 mt-0.5" /> Multi-tenant architecture with 50+ backend functions and 236 automated tests</div>
        </div>
      </div>
    ),
  },
      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-6 text-center mb-12">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <p className="text-muted-foreground mb-6">AI-Powered Decision Governance Infrastructure — investor-ready presentation.</p>
            <Button
              onClick={handleDownload}
              disabled={downloading}
              size="lg"
