    ...
    <header style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 50, backgroundColor: scrolled ? "rgba(14,22,40,0.97)" : DEEP, borderBottom: scrolled ? "1px solid rgba(255,255,255,0.08)" : "1px solid transparent", backdropFilter: "blur(12px)", transition: "background-color 0.3s, border-color 0.3s" }}>
      <div className="qv-nav-inner">
        ...
        <nav className="qv-nav-links">
          ...
          <Link to="/trust" style={{ fontSize: 14, color: "rgba(255,255,255,0.65)", textDecoration: "none" }}>Security</Link>
...
const Pricing = () => {
  const plans = [
    ...
    { name: "Governance", price: "€1,999", cadence: "/month", seats: "15 seats", features: ["Everything in Essentials", "Causal inference engine", "Outcome learning + calibration", "AICIS geopolitical signals", "Advanced board reporting", "SCIM + SSO available when configured"], featured: true },
    { name: "Enterprise", price: "From €6,500", cadence: "/month", seats: "Unlimited seats", features: ["Everything in Governance", "All connectors", "On-premise deployment option", "Dedicated onboarding", "99.9% availability target, contractually committed where agreed", "Procurement pack"], featured: false },
  ];
