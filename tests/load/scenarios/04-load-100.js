// tests/load/scenarios/04-load-100.js
...
export const options = {
  scenarios: {
    load: { executor: "ramping-vus", startVUs: 0, stages: [
      { duration: "1m", target: 100 }, { duration: "4m", target: 100 }, { duration: "1m", target: 0 },
    ] },
    isolation: { executor: "per-vu-iterations", vus: 2, iterations: 1, startTime: "6m", exec: "isolationCheck" },
  },
  thresholds: thresholds("load-100"),
};

export function setup() { guard({ stage: "load-100", vus: 100 }); }
